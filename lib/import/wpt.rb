    ...
    def log_results
      unless ENV['HOSTEDGRAPHITE_APIKEY'].nil? || !test_complete?
        ...
        unless wpt['data']['runs']['1']['firstView'].nil?
          ...
          metrics += key + ".wpt.first_view.score_combine #{first_view['score_combine']}\n"
          metrics += key + ".wpt.first_view.score_compress #{first_view['score_compress']}\n"
        ...
        unless wpt['data']['runs']['1']['repeatView'].nil?
          ...
          metrics += key + ".wpt.repeat_view.score_combine #{repeat_view['score_combine']}\n"
          metrics += key + ".wpt.repeat_view.score_compress #{repeat_view['score_compress']}\n"
